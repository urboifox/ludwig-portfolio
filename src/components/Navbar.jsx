      ...
      <div className="flex flex-col w-full">
        <div className="flex justify-between w-full">
          <div>
            <Link
              to="/"
              className="text-white font-montserrat tracking-tighter text-[25px] xs:text-[46px] uppercase font-bold"
            >
              {data.heading}
            </Link>
            <p className="text-secondary font-brandonLight text-[16px] xs:text-[25px] font-light">
              {data.subHeading}
            </p>
          </div>
          <a
        ...
        <div className="pt-10 w-full xs:justify-start xs:gap-14 flex items-center justify-between">
          <a
